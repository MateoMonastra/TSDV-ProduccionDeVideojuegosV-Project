...
namespace PlayerCheats
{
    ...
    public class CheatsManager : MonoBehaviour
    {
        ...
        /// <summary>Cheat: activa el buff de dash; si está en cooldown, lo resetea. Dispara anim Get en HUD.</summary>
        private void OnDashPickUpCheat()
        {
            ...
            hud?.TriggerPickupGet(PickupId.DashBuff);
        }

        /// <summary>Cheat: otorga un salto extra. Dispara anim Get en HUD.</summary>
        private void OnJumpPickUpCheat()
        {
            ...
            hud?.TriggerPickupGet(PickupId.ExtraJump);
        }
